...
- (void)testItShouldStubWithASelector {
    ...
    XCTAssertEquals([mock raiseShields], NO, @"expected method to be stubbed with the correct value");
}
...
- (void)testItShouldStubWithASelectorAndReturnValue {
    ...
    XCTAssertEquals([mock crewComplement], 42u, @"expected method to be stubbed with the correct value");
}
...
- (void)testItShouldStubWithASelectorReturnValueAndArguments {
    ...
    XCTAssertEquals([mock energyLevelInWarpCore:3], 30.0f, @"expected method with arguments to be stubbed with the correct value");
...
- (void)testItShouldStubWithASelectorReturnValueAndAnyArguments {
    ...
    XCTAssertEquals([mock energyLevelInWarpCore:3], 30.0f, @"expected method with any() arguments to be stubbed");
    XCTAssertEquals([mock energyLevelInWarpCore:2], 30.0f, @"expected method with any() arguments to be stubbed");
}
...
- (void)testItShouldStubWithAMessage {
    ...
    XCTAssertEquals(ratio, 0.0f, @"expected mock to have message stubbed");
}
...
- (void)testItShouldStubWithAReturnValueAndMessage {
    ...
    float ratio = [mock energyLevelInWarpCore:3];
    XCTAssertEquals(ratio, 42.0f, @"expected mock to have message stubbed");
}
...
- (void)testItShouldStubWithDifferentReturnValuesAndMessage {
    ...
    XCTAssertEquals(firstRatio, 42.0f, @"expected mock to have message stubbed");
    float secondRatio = [mock energyLevelInWarpCore:3];
    XCTAssertEquals(secondRatio, 42.0f, @"expected mock to have message stubbed");
    float thirdRatio = [mock energyLevelInWarpCore:3];
    XCTAssertEquals(thirdRatio, 43.0f, @"expected mock to have message stubbed and changed return value");
}
...
- (void)testItShouldStubWhitelistedMethods {
    ...
    XCTAssertEquals([mock hash], 4242u, @"expected method to be stubbed");
...
- (void)testItShouldReturnMethodSignaturesForMethodsOfMockedClasses {
    ...
    XCTAssertEquals([signature numberOfMessageArguments], 1u, @"expected number of arguments to match");
...
- (void)testItShouldReturnResultsForMethodsOfMockedClass {
    ...
    XCTAssertEquals([mock energyLevelInWarpCore:4], 0.0f, @"expected method to be stubbed");
}
...
- (void)testItShouldStubAndReturnResultsForMethodsOfMockedClass {
    ...
    XCTAssertEquals([mock energyLevelInWarpCore:41111], 123.456f, @"expected method to be stubbed");
}
...
- (void)testItShouldReturnMethodSignaturesForMethodsOfMockedProtocols {
    ...
    XCTAssertTrue(KWObjCTypeEqualToObjCType([signature methodReturnType], @encode(NSUInteger)), @"expected return types to match");
    XCTAssertEquals([signature numberOfMessageArguments], 0u, @"expected number of arguments to match");
}

- (void)testItShouldReturnResultsForMethodsOfMockedProtocols {
    id mock = [KWMock mockForProtocol:@protocol(JumpCapable)];
    [mock stub:@selector(hyperdriveFuelLevel)];
    XCTAssertEquals([mock hyperdriveFuelLevel], 0u, @"expected method to be stubbed");
}
...
- (void)testItShouldStubAndReturnResultsForMethodsOfMockedProtocols {
    ...
    XCTAssertEquals([mock hyperdriveFuelLevel], 4242u, @"expected method to be stubbed");
}

- (void)testItShouldReturnResultsForMethodsOfIndirectConformedProtocols {
    id mock = [KWMock mockForProtocol:@protocol(JumpCapable)];
    [mock stub:@selector(orbitPeriodForMass:)];
    XCTAssertEquals([mock orbitPeriodForMass:20.0f], 0.0f, @"expected method to be stubbed");
}
...
- (void)testItShouldStubAndReturnResultsForMethodsOfIndirectConformedProtocols {
    ...
    XCTAssertEquals([mock orbitPeriodForMass:20.0f], 100.0f, @"expected method to be stubbed");
}
...
- (void)testItShouldStubAndUnstubStubCopy {
    ...
    XCTAssertEquals(mock, cruiser, @"expected copy to be stubbed");
    [mock clearStubs];
...
- (void)testItShouldStubInit {
    ...
    XCTAssertEquals(cruiser, otherMock, @"expected init to be stubbed");
}
...
- (void)testItShouldStubInitAndReturnSelfByDefaultForNullMocks {
    ...
    [Cruiser stub:@selector(alloc) andReturn:mock];
    id cruiser = [[Cruiser alloc] init];
    XCTAssertEquals(cruiser, mock, @"expected init to be stubbed");
}
...
- (void)testItShouldAllowStubbingValueForKey {
    ...
    XCTAssertEquals(value, otherMock, @"expected valueForKey: to be stubbed");
}
...
- (void)testItShouldAllowStubbingValueForKeyPath {
    ...
    XCTAssertEquals(value, otherMock, @"expected valueForKeyPath: to be stubbed");
}
...
- (void)testItShouldAllowStubbingSetValueForKey {
    ...
    [mock stub:@selector(setValue:forKey:) withBlock:^id(NSArray *params) {
        XCTAssertEquals(params[0], @"baz", @"expected arg 1 of setValue:forKey: to be 'baz'");
        XCTAssertEquals(params[1], @"foo", @"expected arg 2 of setValue:forKey: to be 'foo'");
        called = YES;
        return nil;
    }];
...
- (void)testItShouldAllowStubbingSetValueForKeyPath {
    ...
    [mock stub:@selector(setValue:forKeyPath:) withBlock:^id(NSArray *params) {
        XCTAssertEquals(params[0], @"baz", @"expected arg 1 of setValue:forKeyPath: to be 'baz'");
        XCTAssertEquals(params[1], @"foo.bar", @"expected arg 2 of setValue:forKey: to be 'foo.bar'");
        called = YES;
        return nil;
    }];
