...
- (void)testItShouldConvertToIntValues {
    ...
    XCTAssertEquals(intValue, (int)value, @"expected value to convert wrapped value to int");
}
...
- (void)testItShouldConvertToFloatValues {
    ...
    XCTAssertEquals(floatValue, (float)value, @"expected value to convert wrapped value to float");
}
...
- (void)testItShouldConvertToBoolValues {
    ...
    XCTAssertEquals(boolValue, (BOOL)value, @"expected value to convert wrapped value to bool");
}
...
- (void)testItShouldReturnStructDataValues {
    ...
    XCTAssertEquals(range.location, result.location, @"expected value to return struct data values");
    XCTAssertEquals(range.length, result.length, @"expected value to return struct data values");
}
...
- (void)testItShouldWriteIntValues {
    ...
    XCTAssertEquals(value, result, @"expected value to write int values");
}
...
- (void)testItShouldWriteUnsignedIntValues {
    ...
    [wrappedValue getValue:&result];
    XCTAssertEquals(value, result, @"expected value to write unsigned int values");
}
...
- (void)testItShouldWriteShortValues {
    ...
    short result = 0;
    [wrappedValue getValue:&result];
    XCTAssertEquals(value, result, @"expected value to write short values");
}
...
- (void)testItShouldWriteDoubleValues {
    ...
    double result = 0;
    [wrappedValue getValue:&result];
    XCTAssertEquals(value, result, @"expected value to write double values");
}
...
- (void)testItShouldCompareAscendingOrderedValues {
    ...
    XCTAssertEquals(comparison, NSOrderedAscending, @"expected value to compare ascending ordered wrapped values");
}
...
- (void)testItShouldCompareSameOrderedValues {
    ...
    KWValue *otherWrappedValue = [KWValue valueWithInt:42];
    NSComparisonResult comparison = [wrappedValue compare:otherWrappedValue];
    XCTAssertEquals(comparison, NSOrderedSame, @"expected value to compare same ordered wrapped values");
}
...
- (void)testItShouldCompareDescendingOrderedValues {
    ...
    KWValue *otherWrappedValue = [KWValue valueWithInt:42];
    NSComparisonResult comparison = [wrappedValue compare:otherWrappedValue];
    XCTAssertEquals(comparison, NSOrderedDescending, @"expected value to compare descending ordered wrapped values");
}
